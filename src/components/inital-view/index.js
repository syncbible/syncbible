	...
	return (
		<div className={ styles.initialView }>
			...
			<div className={ styles.content }>
				...
				<p>Having problems? <a href="http://scruffian.wordpress.com/contact/">Email me</a>, or <a href="#" onClick={ ()=> { localStorage.clear(); window.location.href="/"; } }>clear settings and start over</a></p>
