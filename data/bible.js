...
bible.Data.bookNamesByLanguage = {
	...
	'sr': ['1. Mojsijeva','2. Mojsijeva','3. Mojsijeva','4. Mojsijeva','5. Mojsijeva','Knjiga Isusa Navina','Knjiga o sudijama','Knjiga o Ruti','1. Knjiga Samuilova','2. Knjiga Samuilova','1. Knjiga o carevima','2. Knjiga o carevima','1. Knjiga dnevnika','2. Knjiga dnevnika','Jezdrina','Knjiga Nemijina','Knjiga o Jestiri','Knjiga o Jovu','Psalmi','Priče Solomonove','Knjiga propovednikova','Pesma nad pesmama','Knjiga proroka Isaije','Knjiga proroka Jeremije','Plač Jeremijin','Knjiga proroka Jezekilja','Knjiga proroka Danila','Knjiga proroka Osije','Knjiga proroka Joila','Knjiga proroka Amosa','Knjiga proroka Avdije','Knjiga proroka Jone','Knjiga proroka Miheja','Knjiga proroka Nauma','Knjiga proroka Avakuma','Knjiga proroka Sofonije','Knjiga proroka Ageja','Knjiga proroka Zaharije','Knjiga proroka Malahije','Matej','Marko','Luka','Jovan','Dela apostolska','Rimljanima','1. Korinćanima','2. Korinćanima','Galatima','Efescima','Filipljanima','Kološanima','1. Solunjanima','2. Solunjanima','1. Timoteju','2. Timoteju','Titu','Filimonu','Jevrejima','Jakovljeva','1. Petrova','2. Petrova','1. Jovanova','2. Jovanova','3. Jovanova','Judina','Otkrivenje'],
...
bible.Data.supportedVersions = {
	...
	'KJV': { name: 'King James Version (1769) with Strongs Numbers and Morphology', language: 'en' },
	'ESV': { name: 'English Standard Version with Strongs Numbers', language: 'en' },
	'ASV': { name: 'American Standard Version (1901) with Strongs Numbers', language: 'en' },
	'ABP': { name: 'Apostolic Bible Polyglot English Text with Strongs Numbers', language: 'en' },
	'Darby': { name: 'Darby Bible (1889) with Strongs Numbers', language: 'en' },
	...
	'GerLeoRP18': { name: 'Leonberger Bibel, NT (RP19)', language: 'de' },
	...
	'SpaTDP': { name: 'Spanish Traducción de dominio público (Mateo a Romanos)', language: 'es' },
	...
	'ABPGRK': { name: 'Apostolic Bible Polyglot Greek Text', language: 'grc' },
	'Antoniades': { name: 'Antoniades Patriarchal Edition (1904/1912)', language: 'grc' },
	'Elzevir': { name: 'Elzevir Textus Receptus (1624)', language: 'grc' },
	'MorphGNT': { name: 'Morphologically Parsed Greek New Testament based on the SBLGNT', language: 'grc' },
	'SBLGNT': { name: 'The Greek New Testament: SBL Edition', language: 'grc' },
	'TNT': { name: 'Tregelles\' Greek New Testament', language: 'grc' },
	'WHNU': { name: 'Westcott and Hort with NA27/UBS4 variants', language: 'grc' },
	'f35': { name: 'Family 35', language: 'grc' },
	'Aleppo': { name: 'Aleppo Codex', language: 'he' },
	'HebModern': { name: 'Modern Hebrew Bible', language: 'he' },
	'SP': { name: 'Samaritan Pentateuch', language: 'he' },
	'SPMT': { name: 'Masoretic Text parallel to the Samaritan Pentateuch', language: 'he' },
	...
	'DutSVVA': { name: 'De ganse Heilige Schrift bevattende al de kanonieke boeken van het Oude en Nieuwe Testament, met de apocriefe (deuterocanonieke) boeken', language: 'nl' },
	...
	'RusSynodalLIO': { name: 'Russian Synodal Bible, Licht im Osten Edition', language: 'ru' },
